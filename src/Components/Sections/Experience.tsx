const Experience = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className=" text-5xl max-sm:text-3xl" id="Experience">
          Experiences
        </h1>
        <div className="flex max-sm:flex-col max-sm:justify-center items-center gap-4">
          <div className="my-6 max-h-96 border-white border-solid border rounded-xl w-[35pc] max-sm:w-72">
            ...
            <div className="flex flex-col items-center gap-2 justify-center my-14">
              ...
              <ul className="text-white flex flex-col  justify-center my-10">
                <li>
